...
function launch_home()
    ...
    theme_label(f, 'SCILAB INTERACTIVE DASHBOARD', [230 610 550 40], theme_neon_cyan());
    theme_label(f, 'Five domains. One dashboard. Pick a module to begin:', [250 570 500 25], theme_neon_purple());
